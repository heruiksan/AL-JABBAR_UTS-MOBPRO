  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body:
            AktivitasDetail(), // Widget AktivitasDetail langsung ditampilkan tanpa Stack
      ),
    );
  }
}
...
class _AktivitasDetailState extends State<AktivitasDetail> {
  ...
  // Indeks list yang sedang ditampilkan
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          // Container untuk menampilkan isi list
          Expanded(
            child: Container(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      height:
                                          4), // Tambahkan spasi antara baris 1 dan 2
                                  Row(
                                    mainAxisAlignment:
                                        MainAxisAlignment.spaceAround,
                                    children: [
                                  ...
                                  SizedBox(
                                      height:
                                          4), // Tambahkan spasi antara baris 2 dan 3
                                  Padding(
